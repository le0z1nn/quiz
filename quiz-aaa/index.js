...
const questions = [
  {
    question: "qual a fórmula da glicose?",
    answers: [
  ...
  {
    question: "Quais as fases da lua em ordem correta?",
    answers: [
      { text: "Nova, Crescente, Cheia e Minguante", correct: true },
      { text: "Crescente, nova, cheia e minguante", correct: false },
      { text: "Cheia, minguante, nova, crescente ", correct: false },
      { text: "Minguante, cheia, nova, crescente ", correct: false }
    ]
  },
  {
